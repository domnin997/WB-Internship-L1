...
// Используем await, чтобы выполнение кода приостановилось до разрешения promise.
// Вывод номера и вызов следующей функции произойдет только после завершения работы предыдущей.
// Используем async, чтобы указать на асинхронность функции - возможный код после функции продолжит выполнение.
